...
def main(args):
    ...
    run_names_1 = get_all_configs_per_dataset(config_path + "/results/")[
        args.dataset_name_1
    ]["names"]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset_name_1", type=str, required=True, help="Name of the dataset 1."
    )
    parser.add_argument(
        "--dataset_name_2", type=str, required=True, help="Name of the dataset 2."
    )
